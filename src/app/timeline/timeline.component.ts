...
export class TimelineComponent implements OnInit {
  ...
  comments2 = new Map<string, string>([
    ...
    ['Alexis', 'This is heaven on earth!']
  ]);
  ...
  post2 = new Post(this.amy, 'Having fun in New York!', '/assets/images/resources/user-post6.jpg', '2021-04-30  18:32', 2200, this.comments2);
